...
const additionalServices = [
  {
    ...
    title: "Pass Plus",
    description:
      "Post-test training to build your confidence and skills after passing your test. Can help reduce insurance premiums.",
  },
  {
    icon: RefreshCw,
    title: "Refresher Lessons",
    description:
      "For those who've been off the road and want to get back into driving. Perfect for returning drivers.",
  },
  {
    icon: BookOpen,
    title: "Theory Test Support",
    description:
      "Help and practice with theory test questions. We'll help you prepare to pass both tests first time.",
  },
];
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center overflow-hidden">
      ...
      <motion.div className="container relative z-10 text-center">
        ...
        >
          Driving Lessons in <span className="text-gradient">South Wales</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Professional driving instruction tailored to your needs. From complete
          beginners to intensive courses, we&apos;ve got you covered.
        </motion.p>
      </motion.div>
    </section>
  );
...
function ServiceSection({
  ...
  return (
    <section className="relative py-24 bg-[#0a0a0a] overflow-hidden">
      <div className="absolute inset-0">
        <div
          className={`absolute top-0 ${index % 2 === 0 ? "right-0" : "left-0"} w-96 h-96 bg-amber-500/5 rounded-full blur-[100px]`}
        />
        <div
          className={`absolute bottom-0 ${index % 2 === 0 ? "left-0" : "right-0"} w-96 h-96 bg-red-500/5 rounded-full blur-[100px]`}
        />
      </div>
