  ...
  return (
    <section className="relative min-h-[70vh] flex items-center overflow-hidden">
      ...
      <motion.div className="container relative z-10 text-center">
        ...
        >
          Contact <span className="text-gradient">Alyson&apos;s Driving Tuition</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="glass-card p-8 md:p-10">
              ...
              {formState === "success" ? (
                ...
                <div className="text-center py-12">
                  <p className="text-red-400 mb-4">Something went wrong. Please try again or email us directly.</p>
                  <button
                    onClick={() => setFormState("idle")}
