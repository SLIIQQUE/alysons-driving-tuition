    ...
    <section className="relative min-h-[70vh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-64 md:w-[500px] h-64 md:h-[500px] bg-amber-500/20 rounded-full blur-[100px] md:blur-[150px]"
        />
        <motion.div
          animate={{ opacity: [0.2, 0.5, 0.2] }}
          transition={{ duration: 5, repeat: Infinity, delay: 1 }}
          className="absolute bottom-1/4 right-1/4 w-48 md:w-[400px] h-48 md:h-[400px] bg-red-500/15 rounded-full blur-[80px] md:blur-[120px]"
        />
      </div>
      ...
      <motion.div className="container relative z-10 text-center">
        ...
        >
          Your local DVSA Approved Driving Instructor in South Wales
        </motion.p>
      </motion.div>
    </section>
  );
